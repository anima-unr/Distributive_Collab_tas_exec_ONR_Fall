...
bool convert2Dto3D(const sensor_msgs::PointCloud2 pCloud,
  detecting_hand::Conv2DTo3D::Request &req,
  detecting_hand::Conv2DTo3D::Response &res){
...
bool handle_conv_coord(detecting_hand::Conv2DTo3D::Request &req,
  detecting_hand::Conv2DTo3D::Response &res){
...
int main(int argc, char** argv){
  ...
  //ros::Subscriber sub = n.subscribe("/kinect2/sd/points", 1000, callback);
   //ros::Subscriber sub = n.subscribe("/kinect2/hd/image_depth_rect", 1000, callback);
